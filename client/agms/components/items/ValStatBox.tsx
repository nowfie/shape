...
interface ValStatBoxProps {
  item: any;
}

const ValStatBox = ({ item }: ValStatBoxProps) => {
  let Icon = item.icon;
  ...
  return (
    <Link href={`/detail/measurement/${3}`} className={``}>
            ...
            <>
                ...
                <View className="items-center relative justify-center">
                    <View className=" gap-3 m-auto absolute items-center justify-center flex-col ">
                        ...
                        <Text type="para" className="paragraph text-center text-xs ">{item.target} {unitType}</Text>
                    </View>
                    <CircularProgress
